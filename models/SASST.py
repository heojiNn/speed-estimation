...
if __name__ == '__main__':
    ...
    test_input = torch.zeros([batch_size, input_tdim, input_fdim])
    ...
    ast_mdl = ASTModel(label_dim=label_dim,
    ...
    test_input = torch.zeros([batch_size, input_tdim, input_fdim]).cuda()
