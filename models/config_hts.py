...
sample_rate = 16000  # 16000 for scv2/kirun, 32000 for audioset and esc-50
clip_samples = sample_rate * 5  # audio_set 10-sec clip, kirun 5-sec window
...
# for data collection
classes_num = 1  # esc: 50 | audioset: 527 | scv2: 35 | kirun: 1
